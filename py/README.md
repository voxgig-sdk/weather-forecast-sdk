# WeatherForecast Python SDK



The Python SDK for the WeatherForecast API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/weather-forecast-sdk/releases)) or
...
```python
try:
    weathers = client.Weather().list({"location": "example"})
...
```python
client = WeatherForecastSDK.test(testopts, sdkopts)
```
...
| --- | --- | --- |
| `conditions` | `str` | Expected weather conditions |
...
```
py/
├── weatherforecast_sdk.py         -- Main SDK module
...
The main module (`weatherforecast_sdk`) exports the SDK class.
