...
from weatherforecast_sdk.utility import register

# Load features
from weatherforecast_sdk.feature.base_feature import WeatherForecastBaseFeature
from weatherforecast_sdk.features import _has_feature, _make_feature
...
class WeatherForecastSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WeatherForecastUtility()
    ...
    def get_utility(self):
        return WeatherForecastUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WeatherForecastSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Weather(self, data=None) -> "WeatherEntity":
        ...
        from weatherforecast_sdk.entity.weather_entity import WeatherEntity
        return WeatherEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "WeatherForecastSDK":
        if sdkopts is None:
            sdkopts = {}
