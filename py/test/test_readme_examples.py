# WeatherForecast SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WeatherForecastSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WeatherForecastSDK(...) and WeatherForecastSDK.test(...) become
#      WeatherForecastSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "weatherforecast_sdk"
_SDK_CLASS = "WeatherForecastSDK"
