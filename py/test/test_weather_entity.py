    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set WEATHERFORECAST_TEST_WEATHER_ENTID JSON to run live")
        client = setup["client"]
...
def _weather_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "WEATHERFORECAST_TEST_WEATHER_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("WEATHERFORECAST_TEST_WEATHER_ENTID"))
    ...
    _live = env.get("WEATHERFORECAST_TEST_LIVE") == "TRUE"
    return {
        "client": client,
        "data": entity_data,
        "idmap": idmap_resolved,
        "env": env,
        "explain": env.get("WEATHERFORECAST_TEST_EXPLAIN") == "TRUE",
        "live": _live,
