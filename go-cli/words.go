...
func registerSDKWords(r *eng.Registry, client *sdk.WeatherForecastSDK) {
...
func runOp(client *sdk.WeatherForecastSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
