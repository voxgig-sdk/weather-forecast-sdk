...
AQL-driven CLI and REPL for the WeatherForecast SDK. Positional arguments are
...
```sh
go build -o weather-forecast-cli ./...
```
...
./weather-forecast-cli load 1 weather
./weather-forecast-cli load '{id:1}' weather
