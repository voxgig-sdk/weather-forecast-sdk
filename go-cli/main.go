// Command WeatherForecast-cli is a CLI + REPL for the WeatherForecast SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WEATHER_FORECAST_APIKEY (api key), WEATHER_FORECAST_BASE (base url override)")
