...
func registerTools(server *mcp.Server, client *sdk.WeatherForecastSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-forecast_list",
		Description: "List records from WeatherForecast. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-forecast_load",
		Description: "Load a single record from WeatherForecast. " +
...
func runOp(client *sdk.WeatherForecastSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WeatherForecastSDK, name string) (sdk.WeatherForecastEntity, error) {
