// Command WeatherForecast-mcp is an MCP server exposing the WeatherForecast
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WeatherForecast_list  — list records of an entity
//	WeatherForecast_load  — load a single record of an entity
//
