...
| --- | --- | --- | --- |
| Weather | `list` | `GET /weather` | See reference |

## Connect to the API

- Production server: `https://www.baguette-radar.com/api`
...
- `weather-forecast_list`: List records for an entity. Supported entities: `weather`.
- `weather-forecast_load`: Load one record for an entity. No active entity supports this operation.
