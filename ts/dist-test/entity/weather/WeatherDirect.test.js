...
(0, node_test_1.describe)('WeatherDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('WEATHER_FORECAST_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WeatherForecastSDK({
...
function liveScenariosActive() { return false && process.env.WEATHER_FORECAST_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WeatherForecastSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WEATHER_FORECAST_TEST_WEATHER_ENTID'];
    ...
    const client = new __1.WeatherForecastSDK({
        base: 'http://localhost:8080',
