...
(0, node_test_1.describe)('WeatherEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.WeatherForecastSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set WEATHER_FORECAST_TEST_WEATHER_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.WeatherForecastSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['WEATHER_FORECAST_TEST_WEATHER_ENTID'];
    ...
    if (live) {
        client = new __1.WeatherForecastSDK(merge([
