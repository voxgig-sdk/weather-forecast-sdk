...
#      offline in seeded test mode (WeatherForecastSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WeatherForecast_sdk.rb")
  SDK_CLASS = "WeatherForecastSDK"
