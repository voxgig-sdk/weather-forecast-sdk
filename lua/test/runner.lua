...
function runner.env_override(m)
  local live = runner.getenv("WEATHERFORECAST_TEST_LIVE")
  local override = runner.getenv("WEATHERFORECAST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WEATHERFORECAST_TEST_EXPLAIN")
