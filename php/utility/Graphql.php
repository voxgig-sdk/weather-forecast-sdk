...
// WeatherForecast SDK utility: graphql
//
...
class WeatherForecastGraphql
{
    ...
    // equivalent.
    public static function body(WeatherForecastContext $ctx): mixed
    {
    ...
    public static function errors(WeatherForecastContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
