...
// WeatherForecast SDK utility: fetcher
...
class WeatherForecastFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WeatherForecastSDK/1.0)';
    ...
    public static function call(WeatherForecastContext $ctx, string $fullurl, array $fetchdef): array
    {
