...
// WeatherForecast SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WeatherForecastSDK::test)
...
{
    private const SDK_CLASS = 'WeatherForecastSDK';
    ...
    private const SDK_BASE = 'weatherforecast_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../weatherforecast_sdk.php';
