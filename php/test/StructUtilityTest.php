...
// WeatherForecast SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WeatherForecastOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WeatherForecastOmni::structfix($now, Struct::undef()))
                        !== json_encode(WeatherForecastOmni::structfix($val, Struct::undef()))) {
