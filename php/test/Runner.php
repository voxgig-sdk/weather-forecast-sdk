...
class WeatherForecastTestRunner
{
    ...
    {
        $live = self::getenv('WEATHER_FORECAST_TEST_LIVE');
        $override = self::getenv('WEATHER_FORECAST_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WEATHER_FORECAST_TEST_EXPLAIN');
...
class_alias('WeatherForecastTestRunner', 'Runner');
class_alias('WeatherForecastHelpers', 'Helpers');
