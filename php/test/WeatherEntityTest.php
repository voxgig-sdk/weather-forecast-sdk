...
class WeatherEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WEATHERFORECAST_TEST_WEATHER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function weather_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WEATHERFORECAST_TEST_WEATHER_ENTID");
