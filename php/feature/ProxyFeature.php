...
// WeatherForecast SDK proxy feature
...
class WeatherForecastProxyFeature extends WeatherForecastBaseFeature
{
    ...
    public function init(WeatherForecastContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeatherForecastContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
