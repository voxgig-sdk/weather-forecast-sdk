...
// WeatherForecast SDK ratelimit feature
...
class WeatherForecastRatelimitFeature extends WeatherForecastBaseFeature
{
    ...
    private function _acquire(WeatherForecastContext $ctx): void
    {
    ...
    private function _track(WeatherForecastContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
