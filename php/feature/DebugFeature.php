...
// WeatherForecast SDK debug feature
...
class WeatherForecastDebugFeature extends WeatherForecastBaseFeature
{
    ...
    private function _finish(WeatherForecastContext $ctx, bool $ok): void
    {
