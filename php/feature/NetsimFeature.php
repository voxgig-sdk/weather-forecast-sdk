...
// WeatherForecast SDK netsim feature
...
class WeatherForecastNetsimFeature extends WeatherForecastBaseFeature
{
    ...
    private function _simulate(WeatherForecastContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WeatherForecastContext $ctx, array $applied): void
    {
        $client = $this->client;
