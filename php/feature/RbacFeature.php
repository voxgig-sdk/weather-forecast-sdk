...
// WeatherForecast SDK rbac feature
...
class WeatherForecastRbacFeature extends WeatherForecastBaseFeature
{
    ...
    private function _required(WeatherForecastContext $ctx): ?string
    {
    ...
    private function _reject(WeatherForecastContext $ctx, string $required): void
    {
    ...
    private function _track(WeatherForecastContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
