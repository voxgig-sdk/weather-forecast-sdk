...
// WeatherForecast SDK audit feature
...
class WeatherForecastAuditFeature extends WeatherForecastBaseFeature
{
    ...
    private function _emit(WeatherForecastContext $ctx, string $outcome): void
    {
