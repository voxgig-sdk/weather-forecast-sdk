...
This API provides real-time weather data, including temperature, humidity, and forecasts for various locations.

Learn more about Weather Forecast API at [baguette-radar.com](https://baguette-radar.com).
...
const items = await client.Weather().list({ location: "example" })
```
