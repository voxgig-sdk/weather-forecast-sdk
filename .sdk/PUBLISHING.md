...
|---|---|---|
| `ts/` | @voxgig-sdk/weather-forecast-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/weather-forecast-sdk \
      --repository voxgig-sdk/weather-forecast-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/weather-forecast-sdk` shows it, and
`npm trust revoke @voxgig-sdk/weather-forecast-sdk --id=<id>` removes it.
