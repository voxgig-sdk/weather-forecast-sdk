...
// WeatherForecast SDK utility: make_options

class WeatherForecastMakeOptions
{
    ...
    public static function call(WeatherForecastContext $ctx): array
    {
        ...
        //
        // `WeatherForecastSchema::optspec()` is built from the model:
        ...
        $optspec = WeatherForecastSchema::optspec();
