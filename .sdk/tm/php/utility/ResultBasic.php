...
// WeatherForecast SDK utility: result_basic

class WeatherForecastResultBasic
{
    public static function call(WeatherForecastContext $ctx): ?WeatherForecastResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof WeatherForecastError) ? $result->err->msg : (string)$result->err;
