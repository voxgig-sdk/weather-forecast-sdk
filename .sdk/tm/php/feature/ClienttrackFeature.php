...
// WeatherForecast SDK clienttrack feature
...
class WeatherForecastClienttrackFeature extends WeatherForecastBaseFeature
{
    ...
    public function PostConstruct(WeatherForecastContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WeatherForecast-SDK';
