...
// WeatherForecast SDK streaming feature
...
class WeatherForecastStreamingFeature extends WeatherForecastBaseFeature
{
    ...
    private function _iterate(WeatherForecastResult $result): \Generator
    {
    ...
    private function _streamable(WeatherForecastContext $ctx): bool
    {
