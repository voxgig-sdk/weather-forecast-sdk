...
// WeatherForecast SDK idempotency feature
...
class WeatherForecastIdempotencyFeature extends WeatherForecastBaseFeature
{
    ...
    private function _mutating(WeatherForecastContext $ctx): bool
    {
