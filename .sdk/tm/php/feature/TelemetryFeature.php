...
// WeatherForecast SDK telemetry feature
...
class WeatherForecastTelemetryFeature extends WeatherForecastBaseFeature
{
    ...
    private function _close(WeatherForecastContext $ctx, bool $ok): void
    {
