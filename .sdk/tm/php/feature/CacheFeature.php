...
// WeatherForecast SDK cache feature
...
class WeatherForecastCacheFeature extends WeatherForecastBaseFeature
{
    ...
    private function _through(WeatherForecastContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
