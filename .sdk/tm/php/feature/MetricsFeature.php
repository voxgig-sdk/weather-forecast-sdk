...
// WeatherForecast SDK metrics feature
...
class WeatherForecastMetricsFeature extends WeatherForecastBaseFeature
{
    ...
    private function _record(WeatherForecastContext $ctx, bool $ok): void
    {
