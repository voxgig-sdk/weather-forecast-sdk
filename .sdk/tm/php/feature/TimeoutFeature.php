...
// WeatherForecast SDK timeout feature
...
class WeatherForecastTimeoutFeature extends WeatherForecastBaseFeature
{
    ...
    private function _with_timeout(WeatherForecastContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WeatherForecastContext $_ctx, float $ms): void
    {
        $client = $this->client;
