...
local function make_error_util(ctx, err)
  ...
  local msg = "WeatherForecastSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = WeatherForecastError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == WeatherForecastError then
